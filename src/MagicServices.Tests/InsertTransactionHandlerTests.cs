...
namespace MagicServices.Tests.Common.Payment.Commands
{
    ...
    //            InputParameterList: new List<InputParameter>(),
    //            Amount: 90,
    //            Fees: 5,
    //            TotalAmount: 100,
    //            DenominationId: 3,
    ...
    //            quantity: 0,
    //            PaymentProviderId: 1,
    //            InquiryReferenceNumber: "20252323"
    //        ));

    //        _mockDenominationSpecification
    //            .Setup(x => x.GetByIdAsync(o => o.IsActive && o.Id.Equals(command.Transaction.DenominationId), It.IsAny<CancellationToken>()))
